using System;
using EcoEarnServer.ContractEventHandler.Core;
using EcoEarnServer.ContractEventHandler.Core.Application;
using EcoEarnServer.ContractEventHandler.Core.Worker;
...
namespace EcoEarnServer.ContractEventHandler
{
    [DependsOn(
        ...
        typeof(EcoEarnServerContractEventHandlerCoreModule),
    ...
    public class EcoEarnServerContractEventHandlerModule : AbpModule
    {
