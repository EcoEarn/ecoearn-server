...
[DependsOn(
    typeof(EcoEarnServerTestBaseModule)
)]
public class EcoEarnServerDomainTestModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.Configure<IndexSettingOptions>(options =>
        {
            ...
            options.IndexPrefix = "EcoEarnServertest";
        });
    }
        ...
        modules.ForEach(m =>
        {
            ...
            foreach (var t in types)
            {
                AsyncHelper.RunSync(async () =>
                    await elasticIndexService.DeleteIndexAsync("EcoEarnServertest." + t.Name.ToLower()));
            }
        });
    }
